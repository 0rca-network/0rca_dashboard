...
CREATE POLICY "Creators can manage own agents" ON agents 
...
-- Earnings policies
CREATE POLICY "Creators can view earnings for own agents" ON earnings 
  FOR SELECT USING (
...
/*
-- Insert sample agents (after creating a creator profile)
INSERT INTO agents (creator_id, name, description, category, pricing_type, price_details, api_endpoint) VALUES
  ('your-creator-user-id', 'NLP Text Analyzer', 'Advanced natural language processing for sentiment analysis', 'NLP', 'per_token', '{"per_token": 0.001}', 'https://api.example.com/nlp'),
  ('your-creator-user-id', 'Image Classifier', 'State-of-the-art computer vision for image classification', 'Vision', 'per_request', '{"per_request": 0.05}', 'https://api.example.com/vision');
...
INSERT INTO executions (user_id, agent_id, goal, status, token_cost, total_cost, time_taken_ms, results) VALUES
  ('your-user-id', 'agent-id', 'Analyze customer feedback sentiment', 'completed', 1250, 8.75, 3200, '{"summary": "Analysis completed", "sentiment": "positive"}');
*/